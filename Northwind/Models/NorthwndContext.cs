...
public partial class NorthwndContext : DbContext
{
    ...
    {
        var confiBuild = new ConfigurationBuilder().AddJsonFile("appsettings.json").Build();
        var confiSection = confiBuild.GetSection("ConnectionStrings");
        var connectionString = confiSection["DefaultConnection"]??null;
...
//        => optionsBuilder.UseSqlServer("Data Source=BSD-SABARIP01\\SQLEXPRESS;Initial Catalog=NORTHWND;Integrated Security=SSPI;TrustServerCertificate=True;");
